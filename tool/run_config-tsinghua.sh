...
if [ -f /etc/apt/sources.list ]; then
  ...
  sed -i 's/mirrors.*.com/mirrors.tuna.tsinghua.edu.cn/' /etc/apt/sources.list
...
retries=5
timeout=180
trusted-host=pypi.python.org pypi.org files.pythonhosted.org pypi.tuna.tsinghua.edu.cn
